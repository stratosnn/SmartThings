 ...
 */
metadata {
	definition (name: "My Fibaro Double Switch 2 - USB", namespace: "FibarGroup", author: "Fibar Group", mnmn: "SmartThings", vid:"generic-switch-power-energy", runLocally: true, executeCommandsLocally: true) {
		capability "Switch"
		capability "Actuator"
		capability "Sensor"
