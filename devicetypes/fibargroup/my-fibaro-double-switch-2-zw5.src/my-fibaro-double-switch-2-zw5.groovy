 ...
 */
metadata {
	definition (name: "My Fibaro Double Switch 2 ZW5", namespace: "FibarGroup", author: "Fibar Group", mnmn: "SmartThings", vid:"generic-switch-power-energy", runLocally: true, executeCommandsLocally: true) {
		capability "Switch"
