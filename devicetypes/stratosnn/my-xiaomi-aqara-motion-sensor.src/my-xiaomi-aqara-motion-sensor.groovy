...
metadata {
    definition (name: "My Xiaomi Aqara Motion Sensor", namespace: "stratosnn", author: "stratosnn", mnmn: "SmartThings", vid: "generic-motion", ocfDeviceType: "x.com.st.d.sensor.motion") {
	...
	preferences {
		...
		input description: "This setting only changes how long MOTION DETECTED is reported in SmartThings. The sensor hardware always remains blind to motion for 60 seconds after any activity.", type: "paragraph", element: "paragraph", title: "Motion Reset Interval"
		input "motionreset", "number", title: "", description: "Enter number of seconds (default = 120)", range: "1..7200"
		//Date & Time Config
		input type: "paragraph", element: "paragraph", title: "Date & Clock", description: "Set Date Format: US (MDY), UK (DMY), Other (YMD)" 
		input name: "dateformat", type: "enum", title: "Date Format", options:["US","UK","Other"]
		input name: "clockformat", type: "bool", title: "24 Hours clock"
		//Battery Reset Config
		input description: "If you have installed a new battery, the toggle below will reset the Changed Battery date to help remember when it was changed.", type: "paragraph", element: "paragraph", title: "Battery Reset"
		input name: "battReset", type: "bool", title: "Battery Changed?"
		//Battery Voltage Offset
		input description: "Voltage level to be considered for fully charged battery", type: "paragraph", element: "paragraph", title: "Battery Max volts"
		input name: "voltsmax", title: "100% Charge at", type: "decimal", range: "2.8..3.4", defaultValue: 3
		input description: "Voltage level to be considered for fully discharged battery", type: "paragraph", element: "paragraph", title: "Battery Min volts"
		input name: "voltsmin", title: "0% Charge at", type: "decimal", range: "2..2.7", defaultValue: 2.5
	}	
}
