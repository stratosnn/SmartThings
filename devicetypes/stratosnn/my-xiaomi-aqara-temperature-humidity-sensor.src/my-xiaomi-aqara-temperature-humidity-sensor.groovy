...
metadata {
	definition (name: "My Xiaomi Aqara Temperature Humidity Sensor", namespace: "stratosnn", author: "stratosnn", mnmn: "SmartThings", vid: "SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor", ocfDeviceType: "oic.d.thermostat") {
